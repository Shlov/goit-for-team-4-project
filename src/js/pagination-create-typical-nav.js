...
function selectConditionOfButton(i, page) {
            ...
            if (i === page) {
                text = `<button type="button" class="js-pagination__btn js-pagination__btn--current" name="number-page" disabled><span>${i}</span></button>`
                } else {
                text = `<button type="button" class="js-pagination__btn js-pagination__btn--active" name="number-page"><span>${i}</span></button>`
            }
            return text
        }
